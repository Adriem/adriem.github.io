module.constant 'Projects', [
  {
    ...
    name: "Chatsockets"
    pic: "img/chatsockets-preview.jpg"
    url: "http://adriem.noip.me/chatsockets"
    color: "green"
    notice: ''
    type: "web application"
    tags: ["web", "websockets", "coffeescript", "angularjs"]
    description: """
      Websockets demonstration project over the MEAN stack with socket.io
    """
  }, {
    name: "My .vimrc"
    ...
    tags: [""]
    description: """
      Just my .vimrc file, hope you find it interesting!
    """
  }, {
    ...
    description: """
      My collection of custom vim colorschemes
    """
  }, {
